              ...
              <div className="container">
                ...
                <div className="row justify-content-center mt-4 px-3">
                  ...
                  >
                    ...
                    <div id="interChangeSection">
                      {getRouteId.routeId}
                      <hr />
                      <h2 className="interchange">Interchange</h2>
                      <hr />
                      <div className="metro_heading">
                        <div className="div1">
                          <h3 className="pinkRoute">Pink Route</h3>
                          <hr />

                          <ul className="pink_routeul">
                            {StationsMasterD.filter(
                              (station) => station.route_ID === 1
                            ) //filter station which route id 1
                              .map((station) => (
                        ...
                        <div className="div2">
                          <h3 className="redroute">Red Route</h3>

                          <ul className="redrouteul">
                            {StationsMasterD.filter(
                              (station) => station.route_ID === 2
                            ).map((station) => (
                              <li key={station.station_ID}>
                                {station.station_Name}
                              </li>
